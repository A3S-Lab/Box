...
| Pin-honest Live re-tip (Box-owned, OCI `b26155b1`) | WSL2 `/dev/kvm` digest SHA-256 `5bdc558847a0b4643e67648accefce4a4658d6e6ee3cd6a4a6941bb8063f6cad` (Box `357fc359…`; OCI pin `b26155b1…`; tip system-image asset). Same retained stream/FS / `box_owned_ensure_proven` bar; B2 stays false. |
| Same-tip Live triad (Box `1356d4bb` / OCI `b26155b1`) | Digest SHA-256 `9a0b744f8e829e172480f13d28ba6e66ea8f51c0253daf6bbb0392f16815dd11`. Prior pin-honest digests remain historical. B2 stays false. |
