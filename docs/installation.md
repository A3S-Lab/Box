...
| --- | --- | --- |
| Pin a release | `--version v3.1.0` | `-Version v3.1.0` |
...
curl --proto '=https' --tlsv1.2 -fsSL \
  ...
  sh -s -- --version v3.1.0 --no-modify-path
```
...
& ([scriptblock]::Create($installer)) -Version v3.1.0 -NoModifyPath
```
...
sh ./install.sh \
  --version v3.1.0 \
  --archive ./a3s-box-v3.1.0-linux-x86_64.tar.gz \
...
.\install.ps1 `
  -Version v3.1.0 `
  -ArchivePath .\a3s-box-v3.1.0-windows-x86_64.zip `
  -Sha256 0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef
```
