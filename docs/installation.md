...
| --- | --- | --- |
| Pin a release | `--version v3.2.7` | `-Version v3.2.7` |
...
curl --proto '=https' --tlsv1.2 -fsSL \
  ...
  sh -s -- --version v3.2.7 --no-modify-path
```
...
& ([scriptblock]::Create($installer)) -Version v3.2.7 -NoModifyPath
```
...
sh ./install.sh \
  --version v3.2.7 \
  --archive ./a3s-box-v3.2.7-linux-x86_64.tar.gz \
...
.\install.ps1 `
  -Version v3.2.7 `
  -ArchivePath .\a3s-box-v3.2.7-windows-x86_64.zip `
  -Sha256 0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef
```
