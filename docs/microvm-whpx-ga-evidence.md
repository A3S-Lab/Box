...
| 5 | Windows default absent-env: omit-isolation stamps OCI DedicatedVm | **tip-proven** — unset `A3S_BOX_OCI_MIGRATION` + packaged Host → create/start/wait stamps `runtime_route=oci_sdk`, guest exit 0 |
