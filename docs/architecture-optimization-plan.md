...
| P2 | OCI DedicatedVm production cutover gates for Linux/KVM — binder: [microvm-kvm-ga-evidence.md](microvm-kvm-ga-evidence.md); gates 1–6 tip-proven (absent-env default + off regression); gates 7–8 + Enterprise GA open | B | Deleting libkrun before §4.5; HVF/WHPX production |
