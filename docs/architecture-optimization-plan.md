...
| P2 | WIN-01 WHPX soak honesty — BindFlt `:ro` absent-detach (`07514c79`), bind-mount + volume-backed init + virtiofs tar matrix (12 tests; digests `a90e7715…` / `6aea2e85…` / `0452f137…`); G2 `49e0c382…` (22×11=242); R24 `9b5e1f3c…` (188×12=2256) tip-proven; writable bind `O_TRUNC` fixed libkrun `5302041` / Box `5835560c` (`win_otrunc_bind_tip=pass`) | A | Claiming Enterprise GA from soak alone; closing B3/B4/B5/B6 |
