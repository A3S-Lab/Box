...
<div className="box-section-heading box-home-code-tour__heading">
  ...
  <h2>Control the local runtime from Rust, TypeScript, Python, or Go.</h2>
  <p>
    Choose a language for a complete example, then scroll through creation,
    resources, files, commands, and cleanup in TypeScript.
  </p>
</div>
